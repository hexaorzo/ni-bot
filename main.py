...
async def on_interaction(interaction):
    ...
    if interaction.data['custom_id'] == 'ticket_modal':
        ...
        await channel.set_permissions(discord.utils.get(interaction.guild.roles, id = 909352299032363029), send_messages=True, read_messages=True, add_reactions=True, embed_links=True, attach_files=True, read_message_history=True, external_emojis=True)
